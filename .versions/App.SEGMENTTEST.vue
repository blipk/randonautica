...
<script>
    ...
    export default {
        created: function() {
            ...
            // Set up navigation
            this.pageItems = [];
            const segmentItemMain = new SegmentedBarItem();
            const segmentItemJournal = new SegmentedBarItem();
            segmentItemMain.title = "Deixis";
            segmentItemMain.pagealias = 'pgHome';
            this.pageItems.push(segmentItemMain);
            
            segmentItemJournal.title = "Journal";
            segmentItemJournal.pagealias = 'pgJournal';
            this.pageItems.push(segmentItemJournal);
        ...
        data() {
            return {
                ...
                radius: 1141,
                pageItems: Array<SegmentedBarItem>[],
            };
        },
        ...
        methods: {
            ...
            onSegmentIndexChange: function(args) {
                this.mainSegmentIndex = args.value;
                console.log('Current segment index: ' + args.value);
                console.log(this.pageItems[this.mainSegmentIndex].pagealias);
                this.$routeToPage(this.pageItems[this.mainSegmentIndex].pagealias, {frame: this.mainFrame});
