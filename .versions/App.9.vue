    ...
    <TabView id="mainTabView" :selectedIndex="mainTabIndex" @selectedIndexChange="mainTabIndexChanged" 
        ...
        <DockLayout stretchLastChild="true">
            ...
            <StackLayout dock="bottom"> 
                <GridLayout rows="auto" columns="auto,*,auto" height="50">
                    ...
                    <TextField col="1" v-model="textFieldValue" hint="Add journal entry..." />
                    <Button col="2" text="Send" class="btn btn-primary btn-rounded-lg" @tap="$routeToModal('pgDialog')" /> 
                </GridLayout>
            </StackLayout>
            <!-- /Bottom -->
        ...
        <TabViewItem title="Journals" iconSource="~/images/penrose.png">
            ...
            androidOffscreenTabLimit="1" androidTabsPosition="bottom">
                <TabViewItem title="Journeys" class="fi" >
                    <StackLayout>
        ...
        methods: {
            ...
            */
            ...
            reloadJournal: function(parent) {
                var journalWebView = View.getViewById(this.page, "journalWebView");
